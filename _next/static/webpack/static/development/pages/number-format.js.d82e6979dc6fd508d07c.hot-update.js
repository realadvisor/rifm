...
var formatFixedPointNumber = function formatFixedPointNumber(value, digits) {
  ...
  var scaledTail = tail != null ? tail.slice(0, digits) : ''; // let number = Number.parseFloat(`${head}.${scaledTail}`);

  var number = _babel_runtime_corejs2_core_js_number_parse_float__WEBPACK_IMPORTED_MODULE_0___default()(parsed); // For fixed format numbers deleting "." must be no-op
  ...
  if (_babel_runtime_corejs2_core_js_number_is_nan__WEBPACK_IMPORTED_MODULE_2___default()(number)) {
    return '';
  } // number = Math.trunc(number * 10 ** digits) / 10 ** digits;
...
//# sourceMappingURL=number-format.js.d82e6979dc6fd508d07c.hot-update.js.map