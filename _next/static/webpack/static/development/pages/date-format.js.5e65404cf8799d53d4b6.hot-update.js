...
var Rifm = function Rifm(props) {
  ...
  var userValue = replace(props.format(props.value)); // state of delete button see comments below about inputType support
  ...
  if (true) {
    react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"](function () {
      ...
      if (input.selectionStart === eventValue.length && !isNoOperation) {
      ...
      var replacedValue = replace(formattedValue);
...
//# sourceMappingURL=date-format.js.5e65404cf8799d53d4b6.hot-update.js.map