...
var Rifm = function Rifm(props) {
  ...
  if (true) {
    react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"](function () {
      ...
      if (append != null && isSizeIncreaseOperation && !isNoOperation && // cursor at the end
      input.selectionStart === eventValue.length) {
        console.log('HERE', formattedValue);
...
//# sourceMappingURL=date-format.js.216459f72aab29285481.hot-update.js.map