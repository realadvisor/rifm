...
var Example = function Example() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4__["createElement"](react__WEBPACK_IMPORTED_MODULE_4__["Fragment"], {
    ...
    format: function format(v) {
      return formatNumber(v, 3, false);
    },
    value: formatNumber(variableFloat, 3, false),
    onChange: function onChange(value) {
      return console.log(parseNumber(value)) || setVariableFloat(parseNumber(value));
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89
...
//# sourceMappingURL=number-format.js.07f4b0ae0f9f1deace64.hot-update.js.map