...
function withAmp(Component, _temp2) {
...
function defaultHead(className, isAmp) {
  if (className === void 0) {
    className = 'next-head';
  }
...
function withSideEffect() {
  ...
  function emitChange(component) {
    state = component.props.reduceComponentsToState([].concat(mountedInstances), component.props);
  ...
  function (_react_1$Component) {
    _inheritsLoose(SideEffect, _react_1$Component);
    ...
    function SideEffect(props) {
      ...
      if (isServer) {
        mountedInstances.add(_assertThisInitialized(_assertThisInitialized(_this)));
        emitChange(_assertThisInitialized(_assertThisInitialized(_this)));
      }
