(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["static/development/pages/number-format.js"],{
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    (window.__NEXT_P=window.__NEXT_P||[]).push(["/number-format", function() {
      var page = __webpack_require__(/*! ./pages/number-format/index.js */ "./pages/number-format/index.js")
      if(true) {
        module.hot.accept(/*! ./pages/number-format/index.js */ "./pages/number-format/index.js", function() {
          if(!next.router.components["/number-format"]) return
          var updatedPage = __webpack_require__(/*! ./pages/number-format/index.js */ "./pages/number-format/index.js")
          next.router.update("/number-format", updatedPage.default || updatedPage)
        })
      }
...
var truncScale = function truncScale(number, scale) {
...
var formatFloatingPointNumber = function formatFloatingPointNumber(value, maxDigits) {
  ...
  var number = _babel_runtime_corejs2_core_js_number_parse_float__WEBPACK_IMPORTED_MODULE_0___default()(parsed);
  ...
  if (parsed.includes('.')) {
    var _formatted$split = formatted.split('.'),
        ...
        formattedHead = _formatted$split2[0];
    ...
    var scaledTail = tail != null ? tail.slice(0, maxDigits) : ''; // skip zero at digits position for non fixed floats
