(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["static/development/pages/phone-format.js"],{
...
var Rifm = function Rifm(props) {
  var _React$useReducer = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])(function (c) {
    return c + 1;
  }, 0),
      refresh = _React$useReducer[1];

  var valueRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null); // state of delete button see comments below about inputType support

  var isDeleleteButtonDownRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(false);
  ...
  */
	...
	_createClass(AsYouType, [{
		...
		value: function input(text) {
			...
			return this.process_input(Object(_parseIncompletePhoneNumber__WEBPACK_IMPORTED_MODULE_7__["default"])(extracted_number));
		}
	}, {
		key: 'process_input',
		...
		value: function attempt_to_format_complete_phone_number() {
			for (var _iterator = this.matching_formats, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
				...
				var formatted_number = Object(_format___WEBPACK_IMPORTED_MODULE_5__["format_national_number_using_format"])(this.national_number, format, this.is_international(), this.national_prefix !== '', this.metadata);
		...
		value: function extract_country_calling_code() {
			var _extractCountryCallin = Object(_parse___WEBPACK_IMPORTED_MODULE_4__["extractCountryCallingCode"])(this.parsed_input, this.default_country, this.metadata.metadata),
		...
		value: function extract_national_prefix() {
			...
			var _strip_national_prefi = Object(_parse___WEBPACK_IMPORTED_MODULE_4__["strip_national_prefix_and_carrier_code"])(this.national_number, this.metadata),
			...
			if (!this.metadata.possibleLengths() || this.is_possible_number(this.national_number) && !this.is_possible_number(potential_national_number)) {
				...
				if (Object(_util__WEBPACK_IMPORTED_MODULE_3__["matchesEntirely"])(this.national_number, this.metadata.nationalNumberPattern()) && !Object(_util__WEBPACK_IMPORTED_MODULE_3__["matchesEntirely"])(potential_national_number, this.metadata.nationalNumberPattern())) {
					return;
				}
			}
		...
		value: function is_possible_number(number) {
			var validation_result = Object(_getNumberType___WEBPACK_IMPORTED_MODULE_6__["check_number_length_for_type"])(number, undefined, this.metadata);
		...
		value: function determine_the_country() {
			this.country = Object(_parse___WEBPACK_IMPORTED_MODULE_4__["find_country_code"])(this.countryCallingCode, this.national_number, this.metadata);
		}
	}, {
		key: 'getNumber',
		value: function getNumber() {
			...
			var phoneNumber = new _PhoneNumber__WEBPACK_IMPORTED_MODULE_1__["default"](this.country || this.countryCallingCode, this.national_number, this.metadata.metadata);
			if (this.carrierCode) {
...
/* harmony import */ var _parse___WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./parse_ */ "./node_modules/libphonenumber-js/es6/parse_.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var PhoneNumberMatcher = function () {
  ...
  _createClass(PhoneNumberMatcher, [{
    ...
    value: function parseAndVerify(candidate, offset, text) {
      ...
      var number = Object(_parse___WEBPACK_IMPORTED_MODULE_9__["default"])(candidate, {
        extended: true,
...
function findNumbers(arg_1, arg_2, arg_3, arg_4) {
	var _sort_out_arguments = Object(_parsePhoneNumber__WEBPACK_IMPORTED_MODULE_1__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
...
function searchPhoneNumbers(arg_1, arg_2, arg_3, arg_4) {
	var _sort_out_arguments2 = Object(_parsePhoneNumber__WEBPACK_IMPORTED_MODULE_1__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
...
/*!*************************************************************!*\
  !*** ./node_modules/libphonenumber-js/es6/getNumberType.js ***!
  \*************************************************************/
/*! exports provided: default, sort_out_arguments */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!**************************************************************!*\
  !*** ./node_modules/libphonenumber-js/es6/getNumberType_.js ***!
  \**************************************************************/
/*! exports provided: default, is_of_type, check_number_length_for_type, merge_arrays */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function isPossibleNumber(arg_1, arg_2, arg_3, arg_4) {
  var _sort_out_arguments = Object(_getNumberType__WEBPACK_IMPORTED_MODULE_0__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
      input = _sort_out_arguments.input,
      options = _sort_out_arguments.options,
      metadata = _sort_out_arguments.metadata;
...
function is_possible_number(national_number, is_international, metadata) {
	switch (Object(_getNumberType___WEBPACK_IMPORTED_MODULE_1__["check_number_length_for_type"])(national_number, undefined, metadata)) {
		case 'IS_POSSIBLE':
			return true;
		// case 'IS_POSSIBLE_LOCAL_ONLY':
...
/*!********************************************************!*\
  !*** ./node_modules/libphonenumber-js/es6/metadata.js ***!
  \********************************************************/
/*! exports provided: default, validateMetadata, getExtPrefix, getCountryCallingCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function parsePhoneNumberFromString() {
	try {
		return _parsePhoneNumber__WEBPACK_IMPORTED_MODULE_0__["default"].apply(this, arguments);
	} catch (error) {
		/* istanbul ignore else */
...
function parse_national_number(number, metadata) {
	...
	if (metadata.possibleLengths()) {
		...
		// Otherwise, we don't do the stripping, since the original number could be
		// a valid short number.
		switch (Object(_getNumberType___WEBPACK_IMPORTED_MODULE_8__["check_number_length_for_type"])(potential_national_number, undefined, metadata)) {
			case 'TOO_SHORT':
			// case 'IS_POSSIBLE_LOCAL_ONLY':
			case 'INVALID_LENGTH':
				break;
...
function searchNumbers(arg_1, arg_2, arg_3, arg_4) {
	var _sort_out_arguments = Object(_parsePhoneNumber__WEBPACK_IMPORTED_MODULE_0__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
	    text = _sort_out_arguments.text,
	    options = _sort_out_arguments.options,
	    metadata = _sort_out_arguments.metadata;
...
/*!****************************************************!*\
  !*** ./node_modules/libphonenumber-js/es6/util.js ***!
  \****************************************************/
/*! exports provided: matchesEntirely */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function isValidNumber(arg_1, arg_2, arg_3, arg_4) {
	var _sort_out_arguments = Object(_getNumberType__WEBPACK_IMPORTED_MODULE_1__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
	    input = _sort_out_arguments.input,
	    options = _sort_out_arguments.options,
	    metadata = _sort_out_arguments.metadata;
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    (window.__NEXT_P=window.__NEXT_P||[]).push(["/phone-format", function() {
      var page = __webpack_require__(/*! ./pages/phone-format/index.js */ "./pages/phone-format/index.js")
      if(true) {
        module.hot.accept(/*! ./pages/phone-format/index.js */ "./pages/phone-format/index.js", function() {
          if(!next.router.components["/phone-format"]) return
          var updatedPage = __webpack_require__(/*! ./pages/phone-format/index.js */ "./pages/phone-format/index.js")
          next.router.update("/phone-format", updatedPage.default || updatedPage)
        })
      }
...
var Example = function Example() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], {
    ...
    refuse: /[^\d]+/g // do not jump after ) until see number before
    ,
...
/***/ 0:
/*!****************************************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2Fphone-format&absolutePagePath=%2FUsers%2Fbogdancadkin%2Fhost%2Frifm%2Fpages%2Fphone-format%2Findex.js ***!
  \****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2Fphone-format&absolutePagePath=%2FUsers%2Fbogdancadkin%2Fhost%2Frifm%2Fpages%2Fphone-format%2Findex.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fphone-format&absolutePagePath=%2FUsers%2Fbogdancadkin%2Fhost%2Frifm%2Fpages%2Fphone-format%2Findex.js!./");
